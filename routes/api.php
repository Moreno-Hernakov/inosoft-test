...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('trans')->group(function () {
        ...
        Route::middleware('isAdmin')->group(function () {
            ...
            Route::get('/motor', [TransaksiController::class, 'getTransMotor']);
            Route::get('/mobil', [TransaksiController::class, 'getTransMobil']);
        ...
        // user
        Route::get('/userauth', [TransaksiController::class, 'getTransUser']);
        Route::get('/finduserauth/{id}', [TransaksiController::class, 'findTransUser']);
